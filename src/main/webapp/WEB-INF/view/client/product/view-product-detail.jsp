    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <!-- format tiền -->
                ...
                <head>
                    <meta charset="utf-8">
                    <title>${currentProduct.getName()}</title>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="border rounded">
                                                <a href="#">
                                                    <img src="/images/product/${currentProduct.getImage()}"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <p class="mb-4">${currentProduct.getShortDesc()}</p>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="tab-content mb-5">
                                                <div class="tab-pane active" id="nav-about" role="tabpanel"
                                                    ...
                                                    <p>${currentProduct.getDetailDesc()}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
